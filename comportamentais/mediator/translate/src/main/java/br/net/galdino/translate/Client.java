package br.net.galdino.translate;

import br.net.galdino.translate.mediator.Mediator;
import br.net.galdino.translate.mediator.TranslatorMediator;
import br.net.galdino.translate.model.EnglishUser;
import br.net.galdino.translate.model.PortugueseUser;

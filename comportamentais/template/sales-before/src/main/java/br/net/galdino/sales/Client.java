package br.net.galdino.sales;

import java.util.Arrays;

import br.net.galdino.sales.model.Buyer;
import br.net.galdino.sales.model.Cart;
import br.net.galdino.sales.model.Category;
import br.net.galdino.sales.model.Product;
import br.net.galdino.sales.service.BestOfferService;

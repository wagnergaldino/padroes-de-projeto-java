package br.net.galdino.command.migration;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import br.net.galdino.command.migration.commands.ProductTable;
import br.net.galdino.command.migration.commands.UserTable;
import br.net.galdino.command.migration.commands.UserTableRoleColumn;

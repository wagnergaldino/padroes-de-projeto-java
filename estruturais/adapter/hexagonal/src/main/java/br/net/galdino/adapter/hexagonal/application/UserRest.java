package br.net.galdino.adapter.hexagonal.application;

import java.util.List;
import java.util.Map;

import br.net.galdino.adapter.hexagonal.core.model.User;
import br.net.galdino.adapter.hexagonal.core.ports.UserRepository;
import br.net.galdino.adapter.hexagonal.core.usecases.UserService;
import br.net.galdino.adapter.hexagonal.infrastructure.UserMemoryDatabaseAdapter;

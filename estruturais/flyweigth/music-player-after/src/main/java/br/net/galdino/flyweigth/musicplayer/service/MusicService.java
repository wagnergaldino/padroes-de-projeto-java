package br.net.galdino.flyweigth.musicplayer.service;
...
import br.net.galdino.flyweigth.musicplayer.model.Music;
import br.net.galdino.flyweigth.musicplayer.musicflyweigth.FlyWeightFactory;

package br.net.galdino.prototype.animation;

import java.util.ArrayList;
import java.util.List;

import br.net.galdino.prototype.animation.model.Person;
import br.net.galdino.prototype.animation.model.PersonSamples;
